...
if __name__ == '__main__':
    ...
    with tf.Session(graph=graph) as sess:
        ...
        image1 = cv2.drawKeypoints(img1_orig, kp1, None,  color = (0, 255, 0))
        image2 = cv2.drawKeypoints(img2_orig, kp2, None, color = (0, 255, 0))
        cv2.imwrite("img1_sp.png", image1)
        cv2.imwrite("img2_sp.png", image2)
        cv2.imwrite("superpoint_matches.png", matched_img)
        ...
        ima1 = cv2.drawKeypoints(img1_orig, sift_kp1, None, color = (0, 255, 0))
        ima2 = cv2.drawKeypoints(img2_orig, sift_kp2, None, color = (0, 255, 0))
        cv2.imwrite("img1_sift.png", ima1)
        cv2.imwrite("img2_sift.png", ima2)
        sift_matched_img = cv2.drawMatches(img1_orig, sift_kp1, img2_orig,
                                           sift_kp2, sift_matches, None,
                                           matchColor=(0, 255, 0),
                                           singlePointColor=(0, 0, 255))
        cv2.imwrite("sift_matches.png", sift_matched_img)
